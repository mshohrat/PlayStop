 ...
 */
class JalaliCalendarTool {
    /**
     * JavaSource_Calendar:
     * The default constructor uses the current Gregorian date to onInitialize the
    ...
    val iranianDate: String
        get() {
            ...
            stringBuilder.append("$iranianYear/")
            if(iranianMonth < 10) {
                stringBuilder.append("0$iranianMonth/")
            } else {
                stringBuilder.append("$iranianMonth/")
            }
            if(iranianDay < 10) {
                stringBuilder.append("0$iranianDay")
            } else {
                stringBuilder.append("$iranianDay")
            }
